(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["v-org-tree"] = factory();
	else
		root["v-org-tree"] = factory();
...
// 判断是否叶子节点
var node_isLeaf = function isLeaf(data, prop) {
  return !(is_array_default()(data[prop]) && data[prop].length > 0);
}; // 创建 node 节点
...
var renderNode = function renderNode(h, data, context) {
  ...
  if (node_isLeaf(data, props.props.children)) {
    cls.push('is-leaf');
  ...
  if (!props.collapsable || data[props.props.expand]) {
    childNodes.push(node_renderChildren(h, children, context));
  }
...
var renderLabel = function renderLabel(h, data, context) {
  ...
  if (props.collapsable && !node_isLeaf(data, props.props.children)) {
...
var node_renderChildren = function renderChildren(h, list, context) {
  if (is_array_default()(list) && list.length) {
  ...
  watch: {
    data: function data(newData) {
      ...
      this._mapData(this.dataCloned, function (item) {
        var _ref = _this2.flatData[item[_this2.prop_id]] || {},
            expand = _ref.expand;
